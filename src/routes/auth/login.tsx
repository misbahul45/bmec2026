...
function RouteComponent() {
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row">
      ...
      <div className="lg:flex-1 bg-secondary/30 relative overflow-hidden flex items-center justify-center px-8 py-16 order-1 lg:order-2 min-h-[200px] lg:min-h-screen">
